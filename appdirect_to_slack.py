### Lambda to manage notifications and service integrations via webhooks e.g. from appdirect
...
#ENV variables: appdirect_key, appdirect_secret, basic_http_auth
# slack_webhook_url - not really needed
...
### generic workflow to create a webhook + subscription
    ...
    all_notifications={"Account Notifications":"account", "DDI Metrics":"ddimetrics", "Host Notifications":"host", "Service Notifications":"service", "New Release Notifications":"newrelease"}
